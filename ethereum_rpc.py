"""Read-only Ethereum JSON-RPC client with bounded in-memory caching."""
...
class EthereumRPCClient:
    """JSON-RPC client deliberately limited to read-only methods."""
    ...
    def call(self, method: str, params: list[Any] | None = None, *, use_cache: bool = True) -> Any:
        if not method or method.startswith("eth_send") or method in self._FORBIDDEN_METHODS:
